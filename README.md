...
2.  Download the `UltraLowGraphic.dll` file from the [releases page]([https://github.com/your_username/your_repo/releases](https://github.com/AESMSIX-OFFICIAL/GraphicMod/releases/tag/Release)).
